...
From the previous exploration, we can see many variations in term of values during one day, it  
makes more sense to me to replace the NA's with the mean of their interval across all days.  
...
If we take a look at the histograms, we can see that filling the NA's with "basic" approaches  
such as means or medians tend to centralize data, hence eventually skewing group tendencies.
...
g2 <- act_pro %>%
    ...
    geom_smooth(aes(color = day_group)) +
